...
let handler = async (m, { conn, command, args }) => {
  ...
  } else conn.reply(m.chat, `XP no es suficiente para comprar  ${count} coins\n para conseguir mas xp farmee con mensajes`, m)
}
handler.help = ['buy<numero de coins>', 'buy <numero de coins>', 'buyall']
handler.tags = ['xp']
